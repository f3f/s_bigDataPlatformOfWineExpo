...
!(function(e, t) {
  ...
  var i,
    ...
    r = {
      ...
      ie: (function() {
        ...
        return (
          !!(e.ActiveXObject || 'ActiveXObject' in e) && ((t.match(/msie\s(\d+)/) || [])[1] || '11')
        )
      })(),
      ...
      config: function(e, t) {
        return (
          ...
          e.extend
            ? (a ? layui.addcss('modules/layer/' + e.extend) : r.link('skin/' + e.extend), this)
            : this
        )
      },
      link: function(t, n, a) {
      ...
      ready: function(e) {
        ...
        return (
          a
            ...
            : r.link('vendor/layer/skin/default/layer.css?v=' + r.v + i, e, t),
          this
        )
      },
      ...
      confirm: function(e, t, n, a) {
        ...
        return (
          s && ((a = n), (n = t)),
          r.open(i.extend({ content: e, btn: o.btn, yes: n, btn2: a }, s ? {} : t))
        )
      },
      msg: function(e, n, a) {
  ...
  ;(l.anim = [
    ...
    (s.pt.auto = function(e) {
      ...
      '' === o.area[0] &&
        o.maxWidth > 0 &&
        (r.ie && r.ie < 8 && o.btn && s.width(s.innerWidth()),
      ...
      switch (o.type) {
        ...
        default:
          '' === o.area[1]
            ? o.fixed && f[1] >= n.height() && ((f[1] = n.height()), t('.' + l[5]))
            : t('.' + l[5])
      }
      return a
    }),
    ...
    (s.pt.tips = function() {
      ...
      t.tips[1] || f.remove(),
        ...
        a
          .find('.' + l[5])
          .css({ 'background-color': t.tips[1], 'padding-right': t.closeBtn ? '30px' : '' }),
        a.css({
    ...
    (o.reselect = function() {
      i.each(i('select'), function(e, t) {
        var n = i(this)
        n.parents('.' + l[0])[0] ||
          (1 == n.attr('layer') && i('.' + l[0]).length < 1 && n.removeAttr('layer').show()),
          (n = null)
      })
    }),
    (s.pt.IE6 = function(e) {
      i('select').each(function(e, t) {
        var n = i(this)
        n.parents('.' + l[0])[0] || 'none' === n.css('display') || n.attr({ layer: '1' }).hide(),
          (n = null)
      })
    }),
          ...
          if (
            (n ||
              p.on('click', t.img, function() {
                ...
                r.photos(
                  i.extend(t, { photos: { start: n, data: u, tab: t.tab }, full: t.full }),
                  !0
                ),
                  h()
              }),
